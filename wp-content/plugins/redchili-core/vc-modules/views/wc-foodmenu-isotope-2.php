				...
				<div class="food-menu4-box">
					...
					<span>
						<span class="fmp-price">
							<span class="fmp-price-amount amount">
							<?php
							switch ( $product->get_type() ) {
								...
								default : ?>
									<?php if($sale) : ?>
									<del><span class="fmp-price-currencySymbol"><?php echo esc_html ( $currency ); ?></span><?php echo  esc_html ( $price ); ?></del><span class="fmp-price-currencySymbol"><?php echo esc_html ( $currency ); ?></span><?php echo esc_html ( $sale ); ?>
									<?php elseif($price) : ?>
									<span class="fmp-price-currencySymbol"><?php echo esc_html ( $currency ); ?></span><?php echo esc_html ( $price ); ?>
									<?php endif; ?>
							<?php break;
							} ?>	
							</span>
					...
					<div class="food-menu4-box-title">
						<h3><a class="rt-woo-iso-2-popup" data-showcart="<?php if ( $showcart == 'true' ) { echo esc_html('1'); } else { echo esc_html('0'); } ?>" data-id="<?php echo absint( $id ); ?>" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
						<p><?php echo wp_kses_post( $content ); ?></p><a href="<?php the_permalink(); ?>" class="default-btn fmp-btn-read-more"><?php esc_html_e( 'Read more' , 'redchili-core' ); ?></a>
					</div>
				</div>
