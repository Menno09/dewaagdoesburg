...
$testi_txt_bord_color_style = $testi_txt_bord_color ? "border-color:{$testi_txt_bord_color};" : 'border-color:none';
?>
<div class="owl-wrap rt-owl-nav-2 rt-owl-testi-1 rt-owl-dot-1 <?php echo esc_attr( $slider_nav_class );?>">
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="rt-owl-testimonial-2 testimonial owl-theme owl-carousel rt-owl-carousel" data-carousel-options="<?php echo esc_attr( $owl_data );?>">		
				<?php if ( $query->have_posts() ) :?>
					...
					<div class="rt-vc-item">
						...
						<div class="rt-vc-content arrow_box" style="<?php echo esc_attr ( $testi_txt_bord_color_style ); ?>">
							<?php
